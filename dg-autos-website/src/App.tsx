...
const services = [
  ...
  { icon: "⚙", title: "Mechanical Service", text: "General mechanical repairs and diagnostics remain available. Contact us to confirm the service and where it can be performed." },
];
const repairTypes = [
...
const appointmentServices = [
  ...
  { value: "Mechanical Repair", label: "Mechanical service inquiry" },
